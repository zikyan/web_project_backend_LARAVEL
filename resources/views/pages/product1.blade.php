...
<body>
        ...
        <div class="row">
            ...
            <p class="product-detail-line-height">This brush is a simple but stylish design. Its unique ergonomic form makes the brush for a flawless finish and excellent for natural beauty.
                ...
                <strong>Bristle material:</strong>  Nylon <br>
                
                <strong>Color:</strong> Black <br>
                
                <strong>Brush handle material:</strong> resin <br>
                
                <strong>Brush Material:</strong> Nylon <br>
                
                <strong>Stem length:</strong> 15CM <br> <br>
                
                <strong>Package content:</strong> <br> <br>
                
                <strong>1pcs makeup brush</strong> <br>
                
                <strong>Warm Tips：</strong>For better effect，before first use, you’d better wash the brushes under cold running water for 2 minutes and allow drying naturally in any ventilated area. <br>
